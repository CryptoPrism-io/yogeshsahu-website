    ...
    <main className="h-screen overflow-y-auto" style={{ background: "var(--ys-surface)", color: "var(--ys-text)" }}>
      ...
      <article className="mx-auto max-w-[760px] px-5 pt-24 pb-16">
        ...
        <div className="mb-3 flex flex-wrap items-center gap-3">
          ...
          <span
            className="rounded px-2 py-0.5 text-[8px] font-bold uppercase tracking-[0.1em]"
            style={{
              fontFamily: "var(--font-mono)",
              background: post.kind === "journal" ? "var(--ys-highlight)" : "var(--ys-accent)",
              color: "var(--ys-surface)",
            }}
          >
            {post.kind === "journal" ? "Journal" : "Thinking"}
          </span>
          {post.mood && (
            <span
              className="text-[9px] uppercase tracking-[0.12em]"
              style={{ fontFamily: "var(--font-mono)", color: "var(--ys-text-soft)", fontStyle: "italic" }}
            >
              mood: {post.mood}
            </span>
          )}
          ...
          {prev ? (
            ...
            >
              ...
              <span
                ...
                style={{ fontFamily: "var(--font-headline)", color: "var(--ys-text)", fontSize: 16, lineHeight: 1.2, letterSpacing: "-0.01em" }}
              >
                {prev.title}
              </span>
            </Link>
