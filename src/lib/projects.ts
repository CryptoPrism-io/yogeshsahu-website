...
export const projects: Project[] = [
  ...
  },
  {
    id: 'cryptoprism-db',
    name: 'CryptoPrism DB',
    description: 'Daily 1,000-coin OHLCV ingestion with 130+ technical indicators across a 3-database Postgres cluster. The market-data foundation every CryptoPrism product reads from.',
    stat: '1,000',
    statLabel: 'coins daily',
    tags: ['Python', 'PostgreSQL', 'Indicators'],
    category: ['tools'],
    language: 'Python',
    featured: false,
    href: '',
    githubHref: '',
    htmlHref: '/projects/cryptoprism-db.html',
    cluster: 'D',
  },
  {
    id: 'cryptoprism-db-h',
    name: 'CryptoPrism DB-H',
    description: 'Second-generation data layer built on the DB learnings — migration tooling, QA telemetry, and a monitored pipeline for the daily market-data batch.',
    stat: 'Daily',
    statLabel: 'monitored batch',
    ...
    href: '',
    githubHref: '',
    htmlHref: '/projects/cryptoprism-db-h.html',
    cluster: 'D',
  },
  {
    id: 'cryptoprism-screener',
    name: 'CryptoPrism Screener',
    description: 'Rule-based market screener that turned the raw DB indicators into actionable token signals — the precursor to the ML-driven scoring that replaced it.',
    stat: 'Signal',
    statLabel: 'rules engine',
    tags: ['Python', 'SQL', 'Screener'],
    category: ['tools'],
    language: 'Python',
    featured: false,
    href: '',
    githubHref: '',
    htmlHref: '/projects/cryptoprism-screener.html',
    cluster: 'D',
  },
  {
    id: 'cryptoprism-socials',
    name: 'CryptoPrism Socials',
    description: 'Content automation engine for the crypto brand — Instagram scheduling, AI caption generation, and a 10-workflow posting pipeline. Internal, no website, everything ran on it.',
    stat: '10',
    statLabel: 'posting workflows',
    tags: ['Python', 'Automation', 'Instagram'],
    category: ['tools'],
    language: 'Python',
    featured: false,
    href: '',
    githubHref: '',
    htmlHref: '/projects/cryptoprism-socials.html',
    cluster: 'D',
  },
  {
    id: 'cryptoprism-news-backtest',
    name: 'Sentiment Backtest Engine',
    description: 'Backtest harness that scored news-sentiment signals against historical price action to size whether automated spot trading was viable before a single trade ran.',
    stat: 'Signal',
    statLabel: 'backtest harness',
    tags: ['Python', 'Sentiment', 'Backtest'],
    category: ['quant'],
    language: 'Python',
    featured: false,
    href: '',
    githubHref: '',
    htmlHref: '/projects/backtest.html',
    cluster: 'D',
  },
  {
    id: 'forex-data-pipeline',
    name: 'Forex Data Pipeline',
    description: 'OANDA-backed forex market-data pipeline with scheduled collection, gap detection, and monitoring alerts — powering the FX session dashboards.',
    stat: '28',
    statLabel: 'FX pairs',
    tags: ['Python', 'OANDA API', 'Scheduler'],
    category: ['tools'],
    language: 'Python',
    featured: false,
    href: '',
    githubHref: '',
    htmlHref: '/projects/forex-pipeline.html',
    cluster: 'D',
  },
  {
    id: 'forexfactory-scraper',
    name: 'ForexFactory Calendar Scraper',
    description: 'Scheduled scraper pulling the ForexFactory economic calendar — red-folder events, impact ratings, and forecast-vs-actual data into the pipeline for event-aware signals.',
    stat: 'Scheduled',
    statLabel: 'event calendar',
    tags: ['Python', 'Scraping', 'Forex'],
    category: ['tools'],
    language: 'Python',
    featured: false,
    href: '',
    githubHref: '',
    htmlHref: '/projects/forexfactory-scraper.html',
    cluster: 'D',
  },
];
